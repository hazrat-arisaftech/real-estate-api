  ...
  describe("POST /blogpost/:userid", () => {
    it("It should POST a blog", (done) => {
      ...
      chai
        ...
        .set(
          "Cookie",
          "accessToken=	eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0NWEwOTFkYTc3NmMyMjFkODMzNjg4MCIsImlhdCI6MTY4NDIyNjUzNX0.qqeMN_Fn-zVs3srmQGl2YmnU80rJADktQ-EiLQlfq5Y"
        )
        .end((err, res) => {
